## Feature Example - Singleton

## Ongoing Questions:

-[] How does Keystone internally know that a thing on the `lists` object is, in fact, a singleton?

This project demonstrates how to add a singleton to Keystone.
