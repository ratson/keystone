import { list, graphql, singleton } from '@keystone-6/core';
...
export const lists: Lists = {
  ...
  Link: list({
    fields: {
      href: text({ validation: { isRequired: true }, isIndexed: 'unique' }),
      text: text(),
    },
  }),
  Publisher: singleton({
